...
static class ExtendedPlayerControl
{
    ...
    {
        return VanillaPlayerData.GetRoleById(id);
    }
    ...
    public static void GetLobbyText(this PlayerControl player, ref string nametext, out string colorstr)
    {
        ...
        if (PlayerVersion.playerVersion.TryGetValue(player.PlayerId, out var ver) && ver != null)
        {
        ...
        out string roleText)
    {
        ...
        if (GameStates.OtherModHost) return false;
