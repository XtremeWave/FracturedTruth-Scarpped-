...
public static class RegistryManager
{
    ...
    public static RegistryKey Keys = SoftwareKeys.OpenSubKey("AU-FracturedTruth", true);
    ...
    public static void Init()
    {
        if (Keys == null)
        {
            Logger.Info("Create FracturedTruth Registry Key", "Registry Manager");
        ...
        Logger.Warn("上次启动的FracturedTruth版本：" + LastVersion, "Registry Manager");
