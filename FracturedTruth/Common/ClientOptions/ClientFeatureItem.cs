...
public class ClientFeatureItem
{
    ...
    public static ToggleButtonBehaviour ClientFeaturesButton { get; private set; }
        ...
        OptionsMenuBehaviour optionsMenuBehaviour)
    {
        try
        {
            ...
            if (CustomBackground == null)
            {
                ...
                CustomBackground.name = "Client Feature Background";
                ...
                ClientFeaturesButton = Object.Instantiate(mouseMoveToggle, generalTab);
                var pos = leaveButton?.transform?.localPosition;
                ClientFeaturesButton.transform.localPosition = pos != null ? pos.Value - new Vector3(1.3f, 0f, 0f) : new(-1.3f, -2.4f, 1f);
                ClientFeaturesButton.name = "FracturedTruth Features Options";
                ClientFeaturesButton.Text.text = Translator.GetString("FracturedTruthFeatures");
                ClientFeaturesButton.Background.color = ColorHelper.ClientFeaColor;
                var modOptionsPassiveButton = ClientFeaturesButton.GetComponent<PassiveButton>();
