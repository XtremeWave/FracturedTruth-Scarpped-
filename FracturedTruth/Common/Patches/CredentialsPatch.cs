...
using System.Linq;
using FracturedTruth.Common.Templates;
    ...
    private static void Postfix(VersionShower __instance)
    {
        ...
        if ((OVersionShower = GameObject.Find("VersionShower")) != null && VisitText == null)
        {
            ...
            VisitText.text = VersionChecker.visit > 0
                ? string.Format(GetString("FracturedTruthVisitorCount"), ColorHelper.ModColor)
                : GetString("ConnectToFracturedTruthServerFailed");
            VisitText.transform.localScale = new Vector3(0.7f, 0.7f, 0.7f);
            VisitText.transform.localPosition = new Vector3(-3.92f, -2.9f, 0f);
            VisitText.enabled = GameObject.Find("FracturedTruth Background") != null;
        ...
        if ((OVersionShower = GameObject.Find("VersionShower")) != null && CreditTextCredential == null)
        {
            ...
            credentialsText += "\n";
            string versionText = $"<color={ColorHelper.ModColor}>FT</color> - <color=#C8FF78>v{Main.DisplayedVersion}</color>";
            ...
            CreditTextCredential.name = "FracturedTruth CreditTex";
            ...
            CreditTextCredential.enabled = GameObject.Find("FracturedTruth Background") != null;
...
internal class TitleLogoPatch
{
    ...
    public static GameObject FracturedTruth_Background;
    ...
    private static void Postfix(MainMenuManager __instance)
    {
        ...
        void FormatButtonColor(PassiveButton button, Sprite borderType, Color inActiveColor, Color activeColor, Color inActiveTextColor, Color activeTextColor)
        {
            ...
            //button.activeSprites.transform.FindChild("Icon")?.gameObject?.SetActive(false);
            //button.inactiveSprites.transform.FindChild("Icon")?.gameObject?.SetActive(false);
            ...
            //activeRenderer.sprite = Utils.LoadSprite("StartBG.jpg", 179f);
            //inActiveRenderer.sprite = Utils.LoadSprite("StartBG.jpg", 179f);
        }
        ...
        FracturedTruth_Background = new GameObject("FracturedTruth Background");
        FracturedTruth_Background.transform.position = new Vector3(0, 0, 520f);
        var bgRenderer = FracturedTruth_Background.AddComponent<SpriteRenderer>();
        bgRenderer.sprite = Utils.LoadSprite("FracturedTruth-BG.png", 179f);
        ...
        starGen.SetDirection(new Vector2(0, 0.5f));
        Starfield.transform.SetParent(FracturedTruth_Background.transform);

        //MeshRenderer meshRenderer = Starfield.GetComponent<MeshRenderer>();
        //MeshFilter meshFilter = Starfield.GetComponent<MeshFilter>();
        ...
        //    Texture texture = Utils.LoadTextureFromResources("FracturedTruth-Logo.png");
        //    if (texture != null)
        //    {
        ...
        logoRenderer.sprite = Utils.LoadSprite("FracturedTruth-Logo.png");
