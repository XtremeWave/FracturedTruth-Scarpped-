...
public class GameStartManagerPatch
{
    ...
    public class GameStartManagerUpdatePatch
    {
        ...
        public static void Prefix(GameStartManager __instance)
        {
            ...
            if (Main.AutoStartGame.Value && AmongUsClient.Instance.AmHost)
            {
                ...
                if (updateTimer >= 50)
                {
                    ...
                    if (GameData.Instance.PlayerCount >= maxPlayers - 1 && !GameStates.IsCountDown)
                    {
        ...
        {
            if (!PlayerVersion.playerVersion.TryGetValue(playerId, out var version)) return acceptVanilla;
