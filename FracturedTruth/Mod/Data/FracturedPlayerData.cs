...
using FracturedTruth.Mod.Role.Core;
using FracturedTruth.Vanilla.Data;
using System;
...
namespace FracturedTruth.Mod.Data;

public class FracturedPlayerData : IDisposable
{
    ///////////////PLAYER_INFO\\\\\\\\\\\\\\\
    public static Dictionary<byte, FracturedPlayerData> AllPlayerData;
    ...
    public FracturedPlayerData RealKiller { get; private set; }
    ...
    ///////////////FUNCTIONS\\\\\\\\\\\\\\\
    public static FracturedPlayerData GetPlayerDataById(byte id) => AllPlayerData[id] ?? null;
    ...
    public void SetRealKiller(FracturedPlayerData killer)
    {
        SetDead();
    ...
    public static void InitializeAll()
    {
        ...
        foreach (var pc in PlayerControl.AllPlayerControls)
        {
            ...
            var id = pc.PlayerId;
            AllPlayerData[id] = new FracturedPlayerData(pc, pc.GetRealName(), colorId);
        }
    }
