...
/// </summary>
public sealed class AllowJoinVanilla : InitializerAttribute<AllowJoinVanilla>
{
    public AllowJoinVanilla(InitializePriority priority = InitializePriority.Normal) : base(priority) { }
}